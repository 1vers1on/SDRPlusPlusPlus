...
* [Reddit](https://www.reddit.com/r/sdrppp/)
* IRC: `#sdrppp` ([libera.chat](https://libera.chat)) __**NO LONGER ACTIVE, JOIN DISCORD INSTEAD**__
...
You can download them [here](https://www.sdrppp.org/nightly). It'll redirect you to the latest nightly on GitHub, scroll down to "Artifacts" and click on the version for your OS.
...
**WARNING: The sdrppp-git AUR package is no longer official, it is not recommended to use it.**
...
Download the app bundle from the latest [nightly build](https://www.sdrppp.org/nightly)
...
This will create the `root_dev` directory that will be used to save the configs of sdrppp and the modules.
...
Warning: This is not for the faint of heart and the instructions are mostly untested. It is recommended to use the [nightly builds](https://www.sdrppp.org/nightly) instead.
