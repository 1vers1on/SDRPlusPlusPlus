...
void CommandArgsParser::defineAll() {
        ...
        std::string root = (std::string)getenv("HOME") + "/Library/Application Support/sdrppp";
#elif defined(__ANDROID__)
        std::string root = "/storage/self/primary/sdrppp";
#else
        std::string root = (std::string)getenv("HOME") + "/.config/sdrppp";
#endif
